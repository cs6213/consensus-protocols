...
class DisjointMultiPaxosFactory[T] extends PaxosFactory[T] with DisjointMultiPaxos[T] {
  override val AcceptorClass: Class[_] = classOf[MultiPaxosAcceptor]
  override val ProposerClass: Class[_] = classOf[MultiPaxosProposer]
  override val LearnerClass: Class[_] = classOf[MultiPaxosLearner]
}
